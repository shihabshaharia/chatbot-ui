...
AS $$
DECLARE
  project_url TEXT := 'https://hlrejfptafkkmzxswmso.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhscmVqZnB0YWZra216eHN3bXNvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNjUzNzM3MiwiZXhwIjoyMDMyMTEzMzcyfQ.Ao1GEVgTp7XQsL62xeUOVg4bGZZEWQYHTVozWUloNlU'; -- full access needed for http request to storage
